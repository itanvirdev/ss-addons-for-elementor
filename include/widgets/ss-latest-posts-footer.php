...
add_action('widgets_init', 'SS_Latest_Posts_Footer_Widget');
function SS_Latest_Posts_Footer_Widget() {
	register_widget('SS_Latest_Posts_Footer_Widget');
}


class SS_Latest_Posts_Footer_Widget extends WP_Widget {

	public function __construct() {
		parent::__construct('ss-latest-posts-footer', 'SS Footer Posts', array(
	...
	public function widget($args, $instance) {
		...
		<div class="ss-footer-news">
			...
			?>
					<div class="ss-footer-news-single mb-15">
	...
	public function form($instance) {
		...
		$choose_style = !empty($instance['choose_style']) ? $instance['choose_style'] : esc_html__('style_1', 'ss-addons');
	?>
		<p>
