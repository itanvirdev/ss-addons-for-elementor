...
add_action('widgets_init', 'SS_Info_Widget');
function SS_Info_Widget() {
	register_widget('SS_Info_Widget');
}


class SS_Info_Widget  extends WP_Widget {

	public function __construct() {
		parent::__construct('SS_Info_Widget', esc_html__('Zibber Info', 'ss-addons'), array(
			'description' => esc_html__('SS Info Widget', 'ss-addons'),
		));
	}
...
?>
	...
	?>
		...
		<p>
			<label for="title"><?php esc_html_e('Short Description:', 'ss-addons'); ?></label>
		</p>
