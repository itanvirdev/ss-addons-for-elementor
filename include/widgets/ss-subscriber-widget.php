...
add_action('widgets_init', 'SS_Subscriber_Widget');
function SS_Subscriber_Widget() {
	register_widget('SS_Subscriber_Widget');
}

class SS_Subscriber_Widget  extends WP_Widget {

	public function __construct() {
		parent::__construct('ss-subscriber-widget', esc_html__('SS Footer Subscriber', 'ss-addons'), array(
...
?>
		...
		<div class="ss-footer-subscribe-area position-relative">
			<div class="ss-footer-subscribe-shape"></div>
			<div class="container">
				<div class="ss-footer-subscribe-bg theme-yellow-bg pt-30 pb-20 z-index">
					<div class="row align-items-center">
						...
						<?php if (!empty($mailchimp_shortcode)) : ?>
							<div class="col-xl-7 col-lg-8">
								<div class="ss-footer-subscribe-form">
