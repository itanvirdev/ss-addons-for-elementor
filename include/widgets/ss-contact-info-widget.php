...
add_action('widgets_init', 'ss_contact_info_widget');
...
class SS_Contact_Info_Widget  extends WP_Widget {
	...
	public function __construct() {
		parent::__construct('ss_contact_info_widget', esc_html__('SS Contact Info', 'ss-addons'), array(
			'description' => esc_html__('SS Contact Info Widget', 'ss-addons'),
		));
	}
...
?>
	...
	?>
		...
		<p>
			<label for="title"><?php esc_html_e('Address:', 'ss-addons'); ?></label>
		</p>
		...
		<p>
			<label for="title"><?php esc_html_e('Email Address:', 'ss-addons'); ?></label>
		</p>
		...
		<p>
			<label for="title"><?php esc_html_e('Phone Number:', 'ss-addons'); ?></label>
		</p>
		...
		<p>
			<label for="title"><?php esc_html_e('Website Url:', 'ss-addons'); ?></label>
		</p>
