...
add_action('widgets_init', 'SS_Services_List_Widget');
function SS_Services_List_Widget() {
	register_widget('SS_Services_List_Widget');
}
class SS_Services_List_Widget extends WP_Widget {

	public function __construct() {
		parent::__construct('ss-services-list', 'SS Services List', array(
