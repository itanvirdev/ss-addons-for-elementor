...
add_action('widgets_init', 'SS_Subscriber2_Widget');
function SS_Subscriber2_Widget() {
	register_widget('SS_Subscriber2_Widget');
}

class SS_Subscriber2_Widget  extends WP_Widget {

	public function __construct() {
		parent::__construct('SS_Subscriber2_Widget', esc_html__('SS Footer Subscriber 2', 'ss-addons'), array(
			'description' => esc_html__('SS Subscriber Widget', 'ss-addons'),
		));
	}
...
?>
		...
		<div class="ss-footer-subscribe-area-two position-relative pt-100">
			<div class="container">
				<div class="ss-footer-subscribe-bg-two theme-yellow-bg pt-30 pb-20 z-index pl-60 pr-60">
					<div class="row align-items-center">
						<div class="col-xl-5 col-lg-4">
							<?php if (!empty($instance['title'])) : ?>
								<div class="ss-footer-subscribe">
									<h3 class="ss-footer-subscribe-title"><?php echo apply_filters('widget_title', $instance['title']); ?></h3>
								</div>
							<?php endif; ?>
						</div>
						<?php if (!empty($mailchimp_shortcode)) : ?>
							<div class="col-xl-7 col-lg-8">
								<div class="ss-footer-subscribe-form ss-footer-subscribe-form-2">
	...
	?>
		...
		<p>
			<label for="title"><?php esc_html_e('Mailchimp Shortcode:', 'ss-addons'); ?></label>
		</p>
		...
		<p>
			<label for="title"><?php esc_html_e('Mailchimp text', 'ss-addons'); ?></label>
		</p>
		...
		<p>
			<label for="title"><?php esc_html_e('Social Title', 'ss-addons'); ?></label>
		</p>
		...
		<p>
			<label for="title"><?php esc_html_e('Facebook:', 'ss-addons'); ?></label>
		</p>
		...
		<p>
			<label for="title"><?php esc_html_e('Twitter:', 'ss-addons'); ?></label>
		</p>
		...
		<p>
			<label for="title"><?php esc_html_e('Instagram:', 'ss-addons'); ?></label>
		</p>
		...
		<p>
			<label for="title"><?php esc_html_e('Youtube:', 'ss-addons'); ?></label>
		</p>
		...
		<p>
			<label for="title"><?php esc_html_e('linkedin:', 'ss-addons'); ?></label>
		</p>
