...
add_action('widgets_init', 'SS_Post_Sidebar_Widget');
function SS_Post_Sidebar_Widget() {
	register_widget('SS_Post_Sidebar_Widget');
}

class SS_Post_Sidebar_Widget extends WP_Widget {

	public function __construct() {
		parent::__construct('ss-latest-posts', 'SS Sidebar Posts Image', array(
			'description'	=> 'Latest Blog Post Widget by SecureSofts'
		));
	}
