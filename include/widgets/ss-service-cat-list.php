...
add_action('widgets_init', 'SS_Latest_Services_Cat_List_Widget');
function SS_Latest_Services_Cat_List_Widget() {
	register_widget('SS_Latest_Services_Cat_List_Widget');
}

class SS_Latest_Services_Cat_List_Widget extends WP_Widget {

	public function __construct() {
		parent::__construct('ss-services-cats-list', 'SS Services Category List', array(
