 ...
 * @since 1.0.0
 */
class SS_Services extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        // ss_services_columns_section
        $this->start_controls_section(
            'ss_services_columns_section',
            [
                'label' => esc_html__('Services - Columns', 'ss-addons'),
            ]
        );
            ...
            <section class="cta__area">
                <div class="container">
                    <div class="cta__inner">
                        <div class="row">
                            <?php foreach ($settings['ss_service_list'] as $key => $item) :
                                $border = ($key == 0) ? 'cta__item-border pr-110' : '';
                                $item_sec_class = ($key == 1) ? 'pl-85' : '';
                                $btn_class = ($key == 1) ? 'ss-btn ss-btn-4' : 'ss-btn ss-btn-3';
                                // Link
                                    ...
                                    <div class="cta__item <?php echo esc_attr($border); ?> <?php echo esc_attr($item_sec_class); ?> pt-40 pb-15 d-sm-flex align-items-start">
                                        ...
                                        <div class="cta__content">
                                            <?php if (!empty($item['ss_service_title'])) : ?>
                                                <h3 class="cta__title"><?php echo ss_kses($item['ss_service_title']); ?></h3>
                                            <?php endif; ?>
                                            <?php if (!empty($item['ss_service_description'])) : ?>
                                                <p class="keyFeatureBlock__text"><?php echo ss_kses($item['ss_service_description']); ?></p>
                                            <?php endif; ?>
                                        ...
                                        <div class="features__content">
                                            <?php if (!empty($item['ss_service_title'])) : ?>
                                                <h3 class="features__title">
                                                    <?php if ($item['ss_services_link_switcher'] == 'yes') : ?>
                                                        <a href="<?php echo esc_url($link); ?>"><?php echo ss_kses($item['ss_service_title']); ?></a>
                                                    <?php else : ?>
                                                        <?php echo ss_kses($item['ss_service_title']); ?>
                                                    <?php endif; ?>
                                                </h3>
                                            <?php endif; ?>

                                            <?php if (!empty($item['ss_service_description'])) : ?>
                                                <p><?php echo ss_kses($item['ss_service_description']); ?></p>
                                            <?php endif; ?>
                                            ...
                                            <?php if (!empty($link)) : ?>
                                                <div class="sv-btn">
                                                    <a target="<?php echo esc_attr($target); ?>" rel="<?php echo esc_attr($rel); ?>" href="<?php echo esc_url($link); ?>" class="link-btn">
                                                        <?php echo ss_kses($item['ss_services_btn_text']); ?> <i class="fa-regular fa-arrow-right"></i></a>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
...
$widgets_manager->register(new SS_Services());
