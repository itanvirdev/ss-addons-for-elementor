 ...
 * @since 1.0.0
 */
class SS_Team extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'ss_team_bg_color',
            [
                'label' => __('Shape BG Color', 'ss-addons'),
        ...
        $repeater->start_controls_tab(
            '_tab_member_info',
            [
                'label' => __('Information', 'ss-addons'),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => __('SS Member Title', 'ss-addons'),
                'placeholder' => __('Type title here', 'ss-addons'),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'show_label' => true,
                'label' => __('Job Title', 'ss-addons'),
                'default' => __('SS Officer', 'ss-addons'),
                'placeholder' => __('Type designation here', 'ss-addons'),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'show_label' => false,
                'placeholder' => __('Type link here', 'ss-addons'),
        ...
        $repeater->add_control(
            'show_social',
            [
                'label' => __('Show Options?', 'ss-addons'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'ss-addons'),
                'label_off' => __('No', 'ss-addons'),
                'return_value' => 'yes',
                'style_transfer' => true,
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label_block' => false,
                'label' => __('Website Address', 'ss-addons'),
                'placeholder' => __('Add your profile link', 'ss-addons'),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label_block' => false,
                'label' => __('Email', 'ss-addons'),
                'placeholder' => __('Add your email link', 'ss-addons'),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label_block' => false,
                'label' => __('Phone', 'ss-addons'),
                'placeholder' => __('Add your phone link', 'ss-addons'),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label_block' => false,
                'label' => __('Facebook', 'ss-addons'),
                'default' => __('#', 'ss-addons'),
                'placeholder' => __('Add your facebook link', 'ss-addons'),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label_block' => false,
                'label' => __('Twitter', 'ss-addons'),
                'default' => __('#', 'ss-addons'),
                'placeholder' => __('Add your twitter link', 'ss-addons'),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label_block' => false,
                'label' => __('Instagram', 'ss-addons'),
                'default' => __('#', 'ss-addons'),
                'placeholder' => __('Add your instagram link', 'ss-addons'),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label_block' => false,
                'label' => __('LinkedIn', 'ss-addons'),
                'placeholder' => __('Add your linkedin link', 'ss-addons'),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label_block' => false,
                'label' => __('Youtube', 'ss-addons'),
                'placeholder' => __('Add your youtube link', 'ss-addons'),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label_block' => false,
                'label' => __('Google Plus', 'ss-addons'),
                'placeholder' => __('Add your Google Plus link', 'ss-addons'),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label_block' => false,
                'label' => __('Flickr', 'ss-addons'),
                'placeholder' => __('Add your flickr link', 'ss-addons'),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label_block' => false,
                'label' => __('Vimeo', 'ss-addons'),
                'placeholder' => __('Add your vimeo link', 'ss-addons'),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label_block' => false,
                'label' => __('Behance', 'ss-addons'),
                'placeholder' => __('Add your hehance link', 'ss-addons'),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label_block' => false,
                'label' => __('Dribbble', 'ss-addons'),
                'placeholder' => __('Add your dribbble link', 'ss-addons'),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label_block' => false,
                'label' => __('Pinterest', 'ss-addons'),
                'placeholder' => __('Add your pinterest link', 'ss-addons'),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label_block' => false,
                'label' => __('Github', 'ss-addons'),
                'placeholder' => __('Add your github link', 'ss-addons'),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $this->add_control(
            'title_tag',
            [
                'label' => __('Title HTML Tag', 'ss-addons'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'h1'  => [
                        'title' => __('H1', 'ss-addons'),
                        'icon' => 'eicon-editor-h1'
                    ],
                    'h2'  => [
                        'title' => __('H2', 'ss-addons'),
                        'icon' => 'eicon-editor-h2'
                    ],
                    'h3'  => [
                        'title' => __('H3', 'ss-addons'),
                        'icon' => 'eicon-editor-h3'
                    ],
                    'h4'  => [
                        'title' => __('H4', 'ss-addons'),
                        'icon' => 'eicon-editor-h4'
                    ],
                    'h5'  => [
                        'title' => __('H5', 'ss-addons'),
                        'icon' => 'eicon-editor-h5'
                    ],
                    'h6'  => [
                        'title' => __('H6', 'ss-addons'),
        ...
        $this->add_responsive_control(
            'align',
            [
                'label' => __('Alignment', 'ss-addons'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => __('Left', 'ss-addons'),
                        'icon' => 'eicon-text-align-left',
                    ],
                    'center' => [
                        'title' => __('Center', 'ss-addons'),
                        'icon' => 'eicon-text-align-center',
                    ],
                    'right' => [
                        'title' => __('Right', 'ss-addons'),
                ...
                <div class="container">
                    <div class="row">
                        <?php foreach ($settings['teams'] as $item) :
                            $title = ss_kses($item['title']);
                            $item_url = esc_url($item['item_url']);

                            if (!empty($item['image']['url'])) {
                                $ss_team_image_url = !empty($item['image']['id']) ? wp_get_attachment_image_url($item['image']['id'], $settings['thumbnail_size']) : $item['image']['url'];
                                $ss_team_image_alt = get_post_meta($item["image"]["id"], "_wp_attachment_image_alt", true);
                            }
                        ?>
                            <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
                                <div class="team__item elementor-repeater-item-<?php echo esc_attr($item['_id']); ?> text-center mb-40">
                                    <div class="team__thumb team__thumb-shape">
                                        <?php if (!empty($ss_team_image_url)) : ?>
                                            <img src="<?php echo esc_url($ss_team_image_url); ?>" alt="<?php echo esc_attr($ss_team_image_alt); ?>">
                                        <?php endif; ?>
                                    ...
                                    <div class="team__content">
                                        ...
                                        <?php if (!empty($item['designation'])) : ?>
                                            <span class="team__designation"><?php echo ss_kses($item['designation']); ?></span>
                                        <?php endif; ?>
                                        <?php if (!empty($item['description'])) : ?>
                                            <p><?php echo ss_kses($item['description']); ?></p>
                                        <?php endif; ?>
...
$widgets_manager->register(new SS_Team());
