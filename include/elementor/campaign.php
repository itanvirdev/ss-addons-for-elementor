 ...
 * @since 1.0.0
 */
class SS_Campaign extends Widget_Base {
  ...
  protected function register_controls() {
    ...
    $this->start_controls_section(
      'ss_campaign_query',
      [
        'label' => esc_html__('Campaign Query', 'ss-addons'),
      ]
    );
    ...
    $this->start_controls_section(
      'ss_campaign',
      [
        'label' => esc_html__('Campaign - Layout', 'ss-addons'),
      ]
    );
    $this->add_control(
      'ss_design_style',
      [
        ...
        'type' => Controls_Manager::SELECT,
        'options' => [
          'layout-1' => esc_html__('Default with Pagination', 'ss-addons'),
          'layout-2' => esc_html__('Slider Donation', 'ss-addons'),
          'layout-3' => esc_html__('Tab Donation', 'ss-addons'),
          'layout-4' => esc_html__('Live Donation', 'ss-addons'),
        ],
        'default' => 'layout-1',
      ]
    );
    ...
    // ss_campaign_columns_section
    $this->start_controls_section(
      'ss_campaign_columns_section',
      [
        'label' => esc_html__('Campaign - Columns', 'ss-addons'),
      ]
    );

    $this->add_control(
      'ss_campaign__for_desktop',
      [
    ...
    // ss_campaign_slider_columns_section
    $this->start_controls_section(
      'ss_campaign_slider_columns_section',
      [
        'label' => esc_html__('Campaign - Columns for Carousel', 'ss-addons'),
      ]
    );

    $this->add_control(
      'ss_campaign_slider_for_xl_desktop',
      [
    ...
    $this->add_control(
      'ss_campaign_slider_for_desktop',
      [
        'label' => esc_html__('Columns for Desktop', 'ss-addons'),
    ...
    $this->add_control(
      'ss_campaign_slider_for_xs_mobile',
      [
  ...
  protected function render() {
    ...
    $carousel_args = [
      'arrows' => ('yes' === $settings['ss_campaign_arrow']),
      'dots' => ('yes' === $settings['ss_campaign_dots']),
      'autoplay' => ('yes' === $settings['ss_campaign_autoplay']),
      'autoplay_speed' => absint($settings['ss_campaign_autoplay_speed']),
      'infinite' => ('yes' === $settings['ss_campaign_infinite']),
      'for_xl_desktop' => absint($settings['ss_campaign_slider_for_xl_desktop']),
      'slidesToShow' => absint($settings['ss_campaign_slider_for_desktop']),
      'for_laptop' => absint($settings['ss_campaign_slider_for_laptop']),
      'for_tablet' => absint($settings['ss_campaign_slider_for_tablet']),
      'for_mobile' => absint($settings['ss_campaign_slider_for_mobile']),
      'for_xs_mobile' => absint($settings['ss_campaign_slider_for_xs_mobile']),
    ];
          ...
          <div class="row align-items-center">
            <div class="col-lg-6">
              <?php if (!empty($settings['ss_section_title_show'])) : ?>
                ...
                <div class="sectionTitle ss-sec-box mb-65">
                    ...
                    <div class="featureBlock__donation">
                      ...
                      <div class="featureBlock__eqn">
                        <div class="featureBlock__eqn__block">
                          <span class="featureBlock__eqn__title"><?php echo esc_html__('our goal', 'ss-addons'); ?></span>
                          <span class="featureBlock__eqn__price"><?php echo $campaign_goal; ?></span>
                        </div>
                        <div class="featureBlock__eqn__block">
                          <span class="featureBlock__eqn__title"><?php echo esc_html__('Raised', 'ss-addons'); ?></span>
                          <span class="featureBlock__eqn__price"><?php echo $campaign_donated_amount; ?></span>
                        </div>
                        <div class="featureBlock__eqn__block">
                          <span class="featureBlock__eqn__title"><?php echo esc_html__('to go', 'ss-addons'); ?></span>
    ...
    <?php else : ?>
      ...
      <section class="campaign__area">
        <div class="container">
          ...
          <?php if ($settings['ss_campaign_pagination'] == 'yes' && '-1' != $settings['posts_per_page']) { ?>
            <div class="col-lg-12">
...
$widgets_manager->register(new SS_Campaign());
