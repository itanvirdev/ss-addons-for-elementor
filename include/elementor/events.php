 ...
 * @since 1.0.0
 */
class SS_Events extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'ss_post_query',
            [
                'label' => esc_html__('Events Query', 'ss-addons'),
            ]
        );
        ...
        $this->start_controls_section(
            'ss_post_',
            [
                'label' => esc_html__('Event - Layout', 'ss-addons'),
            ]
        );
        $this->add_control(
            'ss_design_style',
            ...
            <section class="events-area">
                <div class="container">
                    <div class="row">
                                ...
                                <div class="event__item white-bg mb-10 transition-3 p-relative d-lg-flex align-items-center justify-content-between">
                                    ...
                                    <div class="event__right d-sm-flex align-items-center">
                                        ...
                                        <div class="event__more ml-30">
                                            <a href="<?php echo get_the_permalink(); ?>" class="ss-btn-5 ss-btn-7"><?php echo esc_html__('View Events', 'ss-addons'); ?></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <?php if ($settings['ss_post_pagination'] == 'yes' && '-1' != $settings['posts_per_page']) { ?>
                            <div class="col-lg-12">
...
$widgets_manager->register(new SS_Events());
