 ...
 * @since 1.0.0
 */
class SS_Tutor_Course extends Widget_Base {
    ...
    public function get_title() {
        return __('Tutor Course', 'ss-addons');
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'ss_tutor_query',
            [
                'label' => esc_html__('Tutor Query', 'ss-addons'),
            ]
        );
        ...
        $this->start_controls_section(
            'ss_campaign',
            [
                'label' => esc_html__('Tutor - Layout', 'ss-addons'),
            ]
        );
        $this->add_control(
            'ss_design_style',
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'layout-1' => esc_html__('Grid Style 1', 'ss-addons'),
                    'layout-2' => esc_html__('Grid Style 2', 'ss-addons'),
                    'layout-3' => esc_html__('Grid Style 3', 'ss-addons'),
                    'layout-4' => esc_html__('Grid Style 4', 'ss-addons'),
                ],
                'default' => 'layout-1',
            ]
        );
        ...
        $this->add_control(
            'ss_image_show',
            [
                'label' => esc_html__('Show Image', 'ss-addons'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'ss-addons'),
                'label_off' => esc_html__('Hide', 'ss-addons'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'ss_prcie_show',
            [
                'label' => esc_html__('Show Price', 'ss-addons'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'ss-addons'),
                'label_off' => esc_html__('Hide', 'ss-addons'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'ss_cat_show',
            [
                'label' => esc_html__('Show Category', 'ss-addons'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'ss-addons'),
                'label_off' => esc_html__('Hide', 'ss-addons'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'ss_author_show',
            [
                'label' => esc_html__('Show Author', 'ss-addons'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'ss-addons'),
                'label_off' => esc_html__('Hide', 'ss-addons'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'ss_lessons_show',
            [
                'label' => esc_html__('Show Lessons', 'ss-addons'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'ss-addons'),
                'label_off' => esc_html__('Hide', 'ss-addons'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'ss_duration_show',
            [
                'label' => esc_html__('Show Duration', 'ss-addons'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'ss-addons'),
                'label_off' => esc_html__('Hide', 'ss-addons'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'ss_rating_show',
            [
                'label' => esc_html__('Show Rating', 'ss-addons'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'ss-addons'),
                'label_off' => esc_html__('Hide', 'ss-addons'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'ss_students_show',
            [
                'label' => esc_html__('Show Students', 'ss-addons'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'ss-addons'),
                'label_off' => esc_html__('Hide', 'ss-addons'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Show difficulty', 'ss-addons'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'ss-addons'),
                'label_off' => esc_html__('Hide', 'ss-addons'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Show wishlist', 'ss-addons'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'ss-addons'),
                'label_off' => esc_html__('Hide', 'ss-addons'),
                'return_value' => 'yes',
        ...
        // ss_tutor_columns_section
        $this->start_controls_section(
            'ss_tutor_columns_section',
            [
                'label' => esc_html__('Tutor - Columns', 'ss-addons'),
            ]
        );

        $this->add_control(
            'ss_tutor__for_desktop',
            [
        ...
        // ss_tutor_slider_columns_section
        $this->start_controls_section(
            'ss_tutor_slider_columns_section',
            [
                'label' => esc_html__('Tutor - Columns for Carousel', 'ss-addons'),
            ]
        );

        $this->add_control(
            'ss_tutor_slider_for_xl_desktop',
            [
    ...
    protected function render() {
        ...
        $carousel_args = [
            'arrows' => ('yes' === $settings['ss_tutor_arrow']),
            'dots' => ('yes' === $settings['ss_tutor_dots']),
            'autoplay' => ('yes' === $settings['ss_tutor_autoplay']),
            'autoplay_speed' => absint($settings['ss_tutor_autoplay_speed']),
            'infinite' => ('yes' === $settings['ss_tutor_infinite']),
            'for_xl_desktop' => absint($settings['ss_tutor_slider_for_xl_desktop']),
            'slidesToShow' => absint($settings['ss_tutor_slider_for_desktop']),
            'for_laptop' => absint($settings['ss_tutor_slider_for_laptop']),
            'for_tablet' => absint($settings['ss_tutor_slider_for_tablet']),
            'for_mobile' => absint($settings['ss_tutor_slider_for_mobile']),
            'for_xs_mobile' => absint($settings['ss_tutor_slider_for_xs_mobile']),
        ];
        $this->add_render_attribute('ss-carousel-campaign-data', 'data-settings', wp_json_encode($carousel_args));
        ...
        <?php if ($settings['ss_design_style']  == 'layout-2') : ?>
            <section class="course__area">
                <div class="container">
                        ...
                        ?>
                            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                <div class="course__item-2 transition-3 white-bg mb-30 fix">
                                    <?php if ('yes' === $settings['ss_image_show']) : ?>
                                    ...
                                    <div class="course__content-2">
                                        <div class="course__top-2 d-flex align-items-center justify-content-between">
                                            <?php if ('yes' === $settings['ss_cat_show']) : ?>
                                                <?php if (!empty($terms)) : ?>
                                            ...
                                            <?php if ('yes' === $settings['ss_prcie_show']) : ?>
                                        ...
                                        <div class="course__bottom-2 d-flex align-items-center justify-content-between">
                                            <div class="course__action">
                                                <ul>
                                                    <?php if ('yes' === $settings['ss_students_show']) : ?>
                                                        <li>
                                                    ...
                                                    <?php if ('yes' === $settings['ss_lessons_show']) : ?>
                                                        <li>
                                                            <div class="course__action-item d-flex align-items-center">
                                                                <div class="course__action-icon mr-5">
                                                                    <span>
                                                    ...
                                                    <?php if ('yes' === $settings['ss_rating_show']) : ?>
                                                        <li>
                                                            <div class="course__action-item d-flex align-items-center">
                                                                <div class="course__action-icon mr-5">
                                                                    <span>
                                            ...
                                            <?php if ('yes' === $settings['ss_author_show']) : ?>
                    ...
                    <?php if ($settings['ss_tutor_pagination'] == 'yes' && '-1' != $settings['posts_per_page']) : ?>
                        <div class="row">
                            <div class="col-lg-12">
                                    ...
                                    <div class="course__content-3">
                                                    ...
                                                    <li>
                                                        <div class="course__lesson-3">
                                                            <a href="#">
                                                                ...
                                                                <?php echo $tutor_lesson_count; ?> <?php echo esc_html__('videos', 'ss-addons'); ?>
                                                            </a>
                                                        </div>
                                                    </li>
                                                <?php endif; ?>
                                                    ...
                                                    <li>
                                                        <div class="course__review-3">
                                                            <a href="#">
                                                                ...
                                                                ?>
                                                                <?php echo esc_html__('Reviews', 'ss-addons'); ?>
                                                            </a>
                                                        </div>
                                                    </li>
                                                <?php endif; ?>
                                        ...
                                        <?php if ('yes' === $settings['ss_cat_show']) : ?>
                                            <div class="course__join">
                                                <a href="<?php the_permalink(); ?>" class="ss-btn-5 ss-btn-10"><?php echo ss_kses($settings['ss_btn_text']); ?></a>
                                            </div>
                                        <?php endif; ?>
                            ...
                            <div class="course__filter masonary-menu text-center mb-30">
                                <div class="nav-tabs">
                                    ...
                                    foreach ($filter_list as $list) : ?>
                                        <?php if ($i === 1) : $i++; ?>
                                            <button class="active nav-link" data-filter="*"><?php echo esc_html__('See All', 'ss-addons'); ?></button>
                                            ...
                                            <?php if ('yes' === $settings['ss_lessons_show']) : ?>
                                                <div class="course__lesson">
                                                    <a href="<?php print get_the_permalink() ?>"><svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <?php echo $tutor_lesson_count; ?> <?php print esc_html__('lessons', 'ss-addons'); ?>
                                                    </a>
                                                </div>
                                            <?php endif; ?>
                                        </div>
...
$widgets_manager->register(new SS_Tutor_Course());
