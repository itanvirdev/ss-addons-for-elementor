...
class SS_OCDI_Demo_Importer {
    ...
    public function import_files_config() {
        ...
        foreach ($home_prevs as $key => $prev) {
            ...
            $config[] = [
                ...
                'import_notice'                => esc_html__('After you import this demo, you will have to setup the slider separately.', 'ss-addons'),
            ];
        }
    ...
    public function ocdi_after_import_setup($selected_file) {
        ...
        $this->assign_fronssage_id($selected_file);
    ...
    private function assign_fronssage_id($selected_import) {
    ...
    public function ss_ocdi_rewrite_flush() {
